...
const styles = StyleSheet.create({
  ...
  map: { height: 180, backgroundColor: '#dce3d3', borderRadius: 6, overflow: 'hidden', marginBottom: 16, position: 'relative' }, mapRoad: { position: 'absolute', height: 20, width: '130%', backgroundColor: colors.white }, mapRoadOne: { top: 74, left: -30, transform: [{ rotate: '-12deg' }] }, mapRoadTwo: { top: 62, left: -55, transform: [{ rotate: '62deg' }] }, mapPinOne: { position: 'absolute', left: '30%', top: 38 }, mapPinTwo: { position: 'absolute', right: '22%', bottom: 28 }, point: { paddingVertical: 18, borderTopWidth: 1, borderColor: colors.line }, pointTop: { flexDirection: 'row', justifyContent: 'space-between', gap: 8 }, staffed: { color: colors.ink, backgroundColor: '#e2f3c8', paddingHorizontal: 8, paddingVertical: 5, borderRadius: 10, fontFamily: 'DMSans_700Bold', fontSize: 9, alignSelf: 'flex-start' }, pointNote: { color: colors.muted, fontFamily: 'DMSans_400Regular', fontSize: 12, marginVertical: 12 }, navigate: { minHeight: 48, borderWidth: 1, borderColor: colors.ink, borderRadius: 5, flexDirection: 'row', gap: 8, alignItems: 'center', justifyContent: 'center' }, navigateText: { fontFamily: 'DMSans_700Bold', color: colors.ink }, prototypeBox: { backgroundColor: colors.soft, padding: 18, borderLeftWidth: 4, borderLeftColor: colors.coral }, legalLinks: { flexDirection: 'row', justifyContent: 'center', gap: 20, marginTop: 18 }, legalLink: { minHeight: 44, color: colors.ink, fontFamily: 'DMSans_700Bold', fontSize: 12, textDecorationLine: 'underline', textAlignVertical: 'center', paddingVertical: 13 }, projectCredit: { color: colors.muted, fontFamily: 'DMSans_700Bold', fontSize: 10, textTransform: 'uppercase', letterSpacing: 0.8, textAlign: 'center', marginTop: 12 }, projectCreditLink: { color: colors.ink, textDecorationLine: 'underline' }, copyright: { color: colors.muted, fontFamily: 'DMSans_400Regular', fontSize: 10, lineHeight: 15, textAlign: 'center', marginTop: 7 },
